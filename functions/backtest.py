...
def ma_strategy(ticker:str, 
    ma_short: int = 9,
    ma_long:int = 72) -> pd.DataFrame:
    """
    Trading strategy using moving average.
    
    Args:
        ticker (str): Ticker name.
        ma_short (int): Short moving average window. Default is 9.
        ma_long (int): Long moving average window. Default is 72.
    ...
    entires = mas.ma_crossed_above(mal)
